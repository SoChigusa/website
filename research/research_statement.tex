...
My recent work based on nitrogen-vacancy center \cite{Chigusa:2025xxx} proposes a protocol that suppresses magnetic noise as a decoupling protocol while maintaining broadband sensitivity.
