...
const deformTalkInformation = ({ talks, format }: { talks: Array<any>, format: string }) => {
  let header = "";
  if (format == 'award')
...
const compileCV = ({ seminars, talks, awards }: { seminars: Array<any>, talks: Array<any>, awards: Array<any> }) => {
